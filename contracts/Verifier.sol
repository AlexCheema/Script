...
contract PlonkVerifier {
    ...
    uint16 constant nPublic   = 36;
    uint16 constant nLagrange = 36;
    
    uint256 constant Qmx  = 0;
    uint256 constant Qmy  = 0;
    uint256 constant Qlx  = 182678156399217771182955313842724566760499080232621480538621952242537359665;
    uint256 constant Qly  = 17359402270420386630984930270391132626087891696248148455580200264258142569125;
    uint256 constant Qrx  = 20276858269436849705520548603679530768022766136489953371404279128715948782661;
    uint256 constant Qry  = 7864710651442874572521343711704059575389279465051596928172250820350842869187;
    uint256 constant Qox  = 20079899435580225062038175860337083631654565957509834273206168336271119240215;
    uint256 constant Qoy  = 3207005182692185106538041574404004845670291169798006554821759114824920282392;
    uint256 constant Qcx  = 10452080829043362754328785303137362729143804340185964890747977722984409384102;
    uint256 constant Qcy  = 17223778607455225591236703773383202046451677413260480975784495290422643271878;
    uint256 constant S1x  = 1930911565051133287514569390457358049519534928024038916788243937555383424214;
    uint256 constant S1y  = 18088693731945142964059078134696195726977584920919411792697902460826487612297;
    uint256 constant S2x  = 12474640598134425304040503809009341248740650884981706967414031555716485421353;
    uint256 constant S2y  = 18558700928199798652102152765079151125478502354805410418566803534264867429493;
    uint256 constant S3x  = 9865155928756797937077313681870170232376986387352575058438849705559495547727;
    uint256 constant S3y  = 5403433402889463556072762362900127066551481294453456767539145410284691541399;
    ...
    function verifyProof(uint256[24] calldata _proof, uint256[36] calldata _pubSignals) public view returns (bool) {
        assembly {
            /////////
            ...
            function calculateChallenges(pMem, pPublic) {
                ...
                mstore(add(mIn, 1664 ), calldataload(pA))
                mstore(add(mIn, 1696 ), calldataload(add(pA, 32)))
                mstore(add(mIn, 1728 ), calldataload(pB))
                mstore(add(mIn, 1760 ), calldataload(add(pB, 32)))
                mstore(add(mIn, 1792 ), calldataload(pC))
                mstore(add(mIn, 1824 ), calldataload(add(pC, 32)))
                
                beta := mod(keccak256(mIn, 1856), q) 
            ...
            function calculateLagrange(pMem) {
                ...
                inverseArray(add(pMem, pZhInv), 37 )
